      ...
      <footer className="bg-white border-t p-3 flex-shrink-0">
        <div className="max-w-2xl mx-auto flex gap-2">
          <textarea
            ...
            rows={1}
            className="flex-1 resize-none border rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 text-base"
            style={{ fontSize: '16px' }} // Prevents iOS zoom on focus
          />
          <button
            onClick={sendMessage}
            disabled={!input.trim() || isLoading}
            className="px-4 sm:px-6 py-3 bg-blue-600 text-white rounded-xl font-medium hover:bg-blue-700 transition-colors disabled:opacity-50 flex-shrink-0"
          >
            送信
          </button>
        </div>
